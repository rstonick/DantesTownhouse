...
Shader "Custom/GW_FireSkeletonFlames" {
Properties {
...
#define _BaseVectorProp_arr _propBlock
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				fixed4 col = saturate(lerp(_TintColor, _SecondaryColor, attenuation * 2 * (firePattern.a)) * firePattern.a + (fixed4(1, 1, 1, 1)  * i.color.b*i.color.b * 0.2 + firePattern.a * 0.02) )* _GlowIntensity;
				col = col * 10 * i.color.a * attenuation;
